...
namespace K_Engine {
	...
	luabridge::LuaRef ScriptManager::getTable(const std::string& c_name)
	{
		try {
			...
			cout << "CanEt get lua table, make sure table is accessible or exist";
			return NULL;
		}
	}
	...
	luabridge::LuaRef ScriptManager::getMetatable(luabridge::LuaRef table, const std::string& c_name)
	{
		...
		return meta;
			...
			cout << "CanEt get lua metatable, make sure metatable is accessible or exist";
			return NULL;
		}
	}
	...
	T ScriptManager::getParameter(luabridge::LuaRef table, const std::string& parameterName)
	{
		try {
			...
			cout << "CanEt read parameter, make sure table is properly read and parameter name is correct";
			return NULL;
		}
	}
